...
export default function WritePage({ params }: { params: Promise<{ date: string }>}) {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Share your thoughts, stories, or reflections based on today&apos;s prompt</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button onClick={publishEntry} disabled={publishing}>
